  ...
  return (
    <div className="bg-[#01819D] flex flex-col justify-center items-center space-y-8 mt-12 py-6">
      <div className="flex flex-col space-y-2 text-white items-center px-4">
        <p className="text-4xl 4xl:text-6xl">Shared reviews with your winlads</p>
        <p className="text-xs 4xl:text-lg">
      ...
      <div className="flex flex-col space-y-2 items-center">
        ...
        <p className="text-xs text-white 4xl:text-lg">And join the teams and creators already using Testimonial</p>
