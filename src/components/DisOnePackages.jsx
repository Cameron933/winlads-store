...
import DisOneCard2 from "./DisOneCard2";

const DisOnePackages = () => {
  return (
    <div className="flex flex-col space-y-2 xl:space-y-4 pt-4 bg-[#0094FF]">
