  ...
  return (
    <div className={`rounded-md bg-${bgColor} p-4 4xl:p-6 shadow-md flex flex-col space-y-8`}>
        <div className='flex flex-row justify-between'>
            <p className={`text-${titleColor} text-lg 4xl:text-xl`}>{title}</p>
            <p className={`text-${titleColor} text-lg 4xl:text-xl`}>{price}</p>
        </div>
        <div className='flex flex-col space-y-2'>
            <div className='flex flex-row items-center gap-2'>
                <img src={Correct} alt="" />
                <p className={`text-${descColor} text-xs 4xl:text-sm`}>{desc1}</p>
            </div>
            <div className='flex flex-row items-center gap-2'>
                <img src={Correct} alt="" />
                <p className={`text-${descColor} text-xs 4xl:text-sm`}>{desc2}</p>
            </div>
            <div className='flex flex-row items-center gap-2'>
                <img src={Correct} alt="" />
                <p className={`text-${descColor} text-xs 4xl:text-sm`}>{desc3}</p>
            </div>
        </div>
