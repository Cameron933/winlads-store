    ...
    <div className="special:px-24 xl:px-12 px-8 flex flex-col xl:flex-row gap-8 pb-8 pt-12 md:pt-0 xl:items-center">
      <div className="flex flex-col flex-1">
        ...
        <div className="flex flex-col space-y-2 pb-12">
          ...
          <div className="flex flex-row items-center gap-1">
            <IoIosArrowRoundForward />
            <p>Winner announced 29/2/2024 via Facebook live</p>
          </div>
          <div className="flex flex-row items-center gap-1">
            <IoIosArrowRoundForward />
            <p>The prizes will be drawn using our Digital Draw System</p>
          </div>
          <div className="flex flex-row items-center gap-1">
            <IoIosArrowRoundForward />
            <p>The winner will be contacted immediately via phone</p>
          </div>
          <div className="flex flex-row items-center gap-1">
            <IoIosArrowRoundForward />
            <p>
              Vehicle delivered to you free of charge Australia wide. Or Cash
              prize deposited into your bank account.
            </p>
          </div>
        </div>
        <div>
