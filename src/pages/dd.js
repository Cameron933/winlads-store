...
const MyTable = ({ data }) => {
        ...
        <tbody>
          {data.map((item) => (
            <tr key={item.id}>
              ...
              <td
                className="text-md 2xl:text-xl xl:text-md special:text-4xl md:text-2xl border border-black p-4 lg:text-xl lg:text-left 4xl:text:left xl:text-left mt-5"
                dangerouslySetInnerHTML={{
                  __html: `${item.description || ""}${
                    item.description2 ? "<br />" + item.description2 : ""
                  }${item.description3 ? "<br />" + item.description3 : ""}${
                    item.description4 ? "<br />" + item.description4 : ""
                  }${item.description5 ? "<br />" + item.description5 : ""}${
                    item.description6 ? "<br />" + item.description6 : ""
                  }${item.description7 ? "<br />" + item.description7 : ""}${
                    item.description8 ? "<br />" + item.description8 : ""
                  }`,
                }}
              />
            </tr>
  ...
  // Sample data
  const sampleData = [
    { id: 1, name: "Promotion ", description: "WINLADS Giveaway " },
    {
      id: 2,
      name: "Promoter",
    ...
    },
    {
      ...
      description:"Start Date: 9:00am AEDT 1 January 2024 ",
      description2:"End Date: 5:00pm AEDT 28 February 2024  ",
    },
    {
      id: 4,
      name: "Prize",
      description:"Mazda BT50 Ute or $60,000 Cash ",
    ...
    },
    {
      ...
      name: "Permits",
      description:
        "	NSW Authority Number: [xxx]",
        description2: "ACT Permit Number: [xxx] ",
    },
    {
      id: 7,
      name: "Relevant States  ",
      description: "All Australian states and territories except South Australia",
    },
    { id: 8, name: "Entrants", description: "Entry is open to residents of the Relevant States aged eighteen (18) years or over (Entrants). Employees (as well as their immediate family members) of the Promoter, retailers, suppliers and associated companies and agencies are not eligible to enter in the Promotion." },
    {
      id: 9,
      name: "Entry Procedure",
      description: "Visit the promotions page at  https://winladsgiveaway.com (Site), sign up to one of our membership options, complete the entry form, agree to the Terms & Conditions and click submit. Entrants must enter the Promotion in their own name and will be required to provide all mandatory information, including the Entrant’s full name, residential address, age, date of birth, email address and contact telephone number.",
    },
    {
      id: 10,
    ...
    },
    {
      id: 11,
      name: "Draw Details",
      description: "Draw Date: 29 February 2024 ",
      description2: "Draw Time: 9:00 am AEDT ",
      description3: "Draw Location: 2009/15 Everage Street, Moonee Ponds, Victoria 3039, AU ",
      description4: "Draw Method: Electronic random draw ",
    },
    {
      id: 12,
      name: "Notification of Winners ",
      description:
        "Winners will be notified via email & phone no later than 29 February 2024 ",
    },
    {
      id: 13,
      name: "Notification of winners ",
    ...
    {
      id: 15,
      name: "Unclaimed Prize Redraw",
      description:"Redraw Date: 1 august 2024",
      description2:"Redraw Time:  12pm Melbourne time zone",
      description3:"Redraw Location:  15 everage street Moonee Ponds",
      description4:"Redraw Method: electronic",
    },
    {
      id: 16,
      name: "Notification of Unclaimed Prize Redraw Winners",
      description:
        "Unclaimed prize winners will be notified via email & phone no later than [insert date].",
    },
    {
      id: 17,
      name: "Privacy Policy",
